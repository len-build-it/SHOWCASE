...
['music-widget', 'music-drag-handle', 'music-track-toggle', 'music-track-menu', 'music-play', 'music-previous', 'music-next', 'music-mute', 'music-favorite', 'music-wave', 'music-progress', 'music-time-elapsed', 'music-time-remaining'].forEach((id) => {
...
assert.match(script, /trackMenu\.classList\.add\('is-open'\)/);
assert.match(script, /dragStartY - event\.clientY > 24/);
